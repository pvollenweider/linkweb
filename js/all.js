 ...
 */
		...
		$('.owl-watch').owlCarousel({
           loop:false,
            ...
            navText: [
               "<i class='fas fa-angle-left effect-1'></i>",
               "<i class='fas fa-angle-right effect-1'></i>"
            ],
		    responsive:{
		        0:{
		        			nav: false,
  ...
  $(".slider-wrapper").on("translate.owl.carousel", function(){
        $('.slide-text  h1, .slide-text ul').removeClass('zoomInUp animated').css('opacity', '0');
        $('.slide-text  h2').removeClass('zoomIn animated').css('opacity', '0');
        $('.slider-content-btn').removeClass('fadeInUp animated').css('opacity', '0');
  });

  $(".slider-wrapper").on("translated.owl.carousel", function(){
        $('.slide-text  h1, .slide-text ul').addClass('zoomInUp animated').css('opacity', '1');
        $('.slide-text  h2').addClass('zoomIn animated').css('opacity', '1');
